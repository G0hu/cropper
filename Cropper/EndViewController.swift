...
class EndViewController: UIViewController {
    ...
    let bottomLabel: UILabel = {
        let l: UILabel = UILabel()
        let text = "<span style='color:#C8C8C8'>Share your pictures on Instagram with our<br />hashtags </span>" +
            "<span style='color:white'>#unsqrd</span>" +
            "<span style='color:#C8C8C8'> and </span>" +
            "<span style='color:white'>#unsquared</span>" +
